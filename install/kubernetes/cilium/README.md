...
| envoy.bootstrapConfigMap | string | `nil` | Go off-road and bring your own custom Envoy bootstrap ConfigMap. Provide the name of the ConfigMap with a `bootstrap-config.json` key here. @schema type: [null, string] @schema |
